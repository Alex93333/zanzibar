...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('alain.terieurrr@laposte.net', 'C!@@z4f5gcY8tdtt') #Email with which you want to send information
...
Remove-Item zanzibarbrasavil.ps1
